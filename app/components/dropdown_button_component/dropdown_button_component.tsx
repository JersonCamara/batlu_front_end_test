  ...
  return (
    <div className="relative inline-block text-left text-sm" ref={dropdownRef}>
      <button
        ...
        className="border border-[#D9D9D9] ps-5 pe-3 py-2 rounded-full flex items-center justify-between gap-2"
      >
        Ordenar por
        <ArrowIcon />
      </button>
      {isOpen && (
        <div className="absolute right-0 w-48 mt-2 bg-white border rounded-lg shadow-lg z-10 overflow-hidden">
